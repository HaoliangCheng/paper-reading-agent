...
1. **Q&A Mode** (mode="qa"): User asks a question, stay in current stage
   ...
   - current_stage and next_stage should be the SAME
...
2. **Transition Mode** (mode="transition"): User wants to move to a different stage
   ...
   - current_stage = current stage, next_stage = new stage to transition to
...
- code_analysis: Implementation details""",
        parameters={
            ...
            "properties": {
                ...
                "next_stage": {
                    "type": "string",
                    "description": "The stage after this action. Same as current_stage for Q&A mode, or the new stage for transition mode"
                },
                "mode": {
                    "type": "string",
                    "enum": ["qa", "transition"],
            ...
            "required": ["current_stage", "next_stage", "mode", "reason"]
        }
    )
